window.addEventListener('load', () => {
    ...
    const defaultPopupTexts = [
        "Kỷ niệm đẹp nhất là khi được ở bên cậu",
        "Cậu luôn là ánh sáng trong tim tớ",
        "Cảm ơn vì những lần quan tâm nhỏ xíu nhưng ấm áp",
        "Tớ mong cậu mãi luôn cười như hôm nay",
        "Một khoảnh khắc nhỏ — nhưng là cả thế giới của tớ"
    ];
